...
if (file_exists(__DIR__ . '/../vendor/autoload.php')) {
    ...
    echo json_encode([
        'service' => 'api-scolarite',
        'message' => 'Microservice Scolarite actif. Documentation sur /docs, sante sur /sante.',
        'documentation_url' => 'http://localhost:4004/docs',
        'sante_url' => 'http://localhost:4004/sante',
